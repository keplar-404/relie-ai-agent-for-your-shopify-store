...
- Use 'extract_assets' when you need to locate, crop, and save visual UI elements (logos, hero banners, product images, icons) from image URLs or base64 screenshots into Supabase Storage.
